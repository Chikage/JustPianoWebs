...
n=objrs.recordcount
      ...
      response.write"<form name='form2' method ='post' action='rd_nursery.asp'>"
	  ...
	  response.write"games：<input type='text' name ='games_n' value="& CSTR(n) &"><br>"
	  response.write"games：<input type='text' name ='games_t' value="& t &"><br>"
	  response.write"games：<input type='text' name ='games_D' value="& d &"><br>"
